...
DECLARE_GAUGE(kv_event_zmq_source_count);
DECLARE_COUNTER(xservice_heartbeat_total);
DECLARE_COUNTER(xservice_heartbeat_xtensor_total);
DECLARE_GAUGE(xservice_registration_healthy);
DECLARE_COUNTER(xservice_registration_reconcile_total);
DECLARE_COUNTER(xservice_registration_attempt_total);
DECLARE_COUNTER(xservice_registration_success_total);
DECLARE_COUNTER(xservice_registration_recovery_total);
DECLARE_COUNTER(xservice_registration_failure_total);
